...
**Answer:** Supervised learning is when there is an outcome variable 
...
**Answer** It is useful to stratify by the outcome/target variable when there is a class imbalance in the target variable.
...
**Answer:** We use v-fold cross validation
