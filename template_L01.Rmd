...
**Answer:** The bias-variance trade-off means that there is a tradeoff between the bias and variance - the higher the bias, the lower the variance. 
...
**Answer:** We might use bootstrap resampling when we want performance estimates that have very low variance. 
